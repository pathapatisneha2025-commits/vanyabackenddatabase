  ...
  async (req, res) => {
    ...
    try {
      ...
      /* ==================================================
         ...
         For now this comes from request body.
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      /* ==================================================
         DON'T REJECT ALREADY VERIFIED PAYMENT
      ================================================== */
